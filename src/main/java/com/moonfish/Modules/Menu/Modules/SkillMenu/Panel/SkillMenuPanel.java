package com.moonfish.Modules.Menu.Modules.SkillMenu.Panel;
...
public class SkillMenuPanel {
    ...
    private static void Initialize(Player player) {
        inventory = Bukkit.createInventory(null, 54, "§k|| §r§b熟练度菜单 §r§k||");
        //第一行(0-8)
        ...
        inventory.setItem(12, PanelConfig.getShowPlayerCombatSkill(player));
        inventory.setItem(13, PanelConfig.getShowPlayerMiningSkill(player));
        inventory.setItem(14, PanelConfig.getShowPlayerFarmingSkill(player));
        inventory.setItem(15, PanelConfig.getShowPlayerForagingSkill(player));
        inventory.setItem(16, PanelConfig.getShowPlayerFishingSkill(player));
